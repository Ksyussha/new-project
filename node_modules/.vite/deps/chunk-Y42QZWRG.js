  ...
  return function(b) {
    return function(c2) {
      ...
      return b(function(b2) {
        typeof b2 == "number" ? p(d2)(c2) : b2.tag ? (d2.length >= a && 0 < a && d2.shift(), d2.push(b2[0]), e(0)) : (b2 = b2[0], 0 >= a ? (b2(1), u(c2)) : (e = b2, b2(0)));
      });
    };
  };
}
...
// node_modules/@urql/core/dist/923bca32.mjs
...
var h = typeof TextDecoder != "undefined" ? new TextDecoder() : null;
var p2 = /content-type:[^\r\n]*application\/json/i;
var d = /boundary="?([^=";]+)"?/i;
      ...
      return i3().then(function next(n3) {
        if (!n3.done) {
          var o4 = function toString(e3) {
            return e3.constructor.name === "Buffer" ? e3.toString() : h.decode(e3);
          }(n3.value);
...
//# sourceMappingURL=chunk-Y42QZWRG.js.map
